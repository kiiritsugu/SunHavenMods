...
public static class TotemIndex
{
    ...
    public static ScareCrowEffect[] FourSeasonsEffects = new ScareCrowEffect[]
    {
        ScareCrowEffect.Spring,
        ScareCrowEffect.Summer,
        ScareCrowEffect.Fall,
        ScareCrowEffect.Winter,
        ScareCrowEffect.BasicSpring,
        ScareCrowEffect.BasicSummer,
        ScareCrowEffect.BasicFall,
        ScareCrowEffect.BasicWinter
    };
